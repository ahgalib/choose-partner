...
<head>
   ...
   <meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <link rel="stylesheet" href="{{url('frontCss/choosePartner.css')}}">
        ...
        <nav  class="navbar fixed-top shadow-sm navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/home') }}">
                    {{ config('app.Choose Partner App', 'Choose Partner App') }}
                </a>
                <a href="index.html" class="navbar-brand d-block d-lg-none text-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                    <ul class="navbar-nav mr-auto text-light ml-5">
                        <li>Find a person just like you</li>
                    </ul>
