<div class="row text-light">
    @foreach($profile as $allProfile)
        <div class="col-md-4">
            ...
            <a href="/profilePage/{{$allProfile['user_profile']['id']}}"> <img src="/storage/{{$allProfile['user_profile']['profile_picture']}}" alt="" style="width:200px;height:170px;border-radius: 50%;margin-bottom:20px;"></a>
